...
def bring_data_from_directory():
  ...
  train_generator = datagen.flow_from_directory(
           "/home/ubuntu/ImageFolder",
          target_size=(224, 224),
          batch_size=batch_size,
          class_mode='categorical',  # this means our generator will only yield batches of data, no labels
          shuffle=True,
           classes=['BADMINTON_ACTIVITY','RACQUETBALL_ACTIVITY','LACROSSE_ACTIVITY','LAWNTENNIS_ACTIVITY','SQUASH_ACTIVITY'])
...
def test_on_whole_videos(train_data,train_labels,validation_data,validation_labels):
  parent = os.listdir("/home/ubuntu/ImageFolder")
  ...
  for video_class in parent[1:]:
      print (video_class)
      child = os.listdir("/home/ubuntu/ImageFolder" + "/" + video_class)
      for class_i in child[1:]:
          sub_child = os.listdir("/home/ubuntu/ImageFolder" + "/" + video_class + "/" + class_i)
          for image_fol in sub_child[1:]:
              if (video_class ==  'RACQUETBALL_ACTIVITY' ):
                  if(count%4 == 0):
                      image = imread("/home/ubuntu/ImageFolder" + "/" + video_class + "/" + class_i + "/" + image_fol)
